...
const AboutSection = () => {
  ...
  const stats = [
    { value: "10+", label: "Years Experience", icon: "fa-calendar" },
    { value: "5k+", label: "Happy Pets", icon: "fa-paw" },
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="relative">
              <div className="absolute -left-4 top-0 w-1 h-20 bg-[#5EE6FE] rounded-full" />
            ...
            <motion.button
              ...
              className="inline-flex items-center gap-2 text-[#5EE6FE] font-medium hover:gap-3 transition-all"
            >
              Learn More About Us
          ...
          >
            ...
            >
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="italic text-gray-600 p-4 bg-gray-50 rounded-lg border-l-4 border-[#5EE6FE]">

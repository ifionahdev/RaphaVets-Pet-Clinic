  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className={`fixed ${
          isExpanded ? "w-[420px] h-[520px]" : "w-[320px] h-[420px]"
        } bottom-0 right-4 bg-white rounded-2xl shadow-2xl flex flex-col overflow-hidden z-[60] border border-[#E8F7FA]`}
      >
        {/* HEADER */}
        <div className="bg-[#5EE6FE] text-white py-3 px-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <i
                className={`fa-solid ${
                  isExpanded ? "fa-down-left-and-up-right-to-center" : "fa-up-right-and-down-left-from-center"
                } text-lg`}
              ></i>
            </button>
        ...
        {/* CHAT MESSAGES */}
        <div className="flex-1 overflow-y-auto px-4 py-3 bg-[#F9FBFB] space-y-3">
